...
route.get('/allstores', vendor_controller_1.allStores);
route.get('/allrequests', vendor_controller_1.allRequests);
...
route.get('/select-vendorFeedback', review_controller_1.view_vendor_feedback);
route.get('/select-vendor/:id', vendor_controller_1.selectVendorInfo);
route.get('/vendor/order/:id', vendor_controller_1.vendorOrder);
