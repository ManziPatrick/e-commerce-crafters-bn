...
exports.fetchSimilarProducts = exports.searchProducts = exports.getProductById = exports.getAllProducts = exports.saveProduct = void 0;
...
const fetchSimilarProducts = (productId_1, category_1, ...args_1) => __awaiter(void 0, [productId_1, category_1, ...args_1], void 0, function* (productId, category, limit = 10) {
    try {
        const similarProducts = yield product_1.default.findAll({
            where: {
                category,
                productId: {
